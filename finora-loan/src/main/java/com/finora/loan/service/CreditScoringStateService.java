...
import com.finora.loan.integration.ai.StoredAiCreditResponse;
import com.finora.loan.mapper.AiCreditScoringMapper;
import com.finora.loan.repository.BorrowerCreditProfileRepository;
...
public class CreditScoringStateService {
    ...
    public Long applyEligibility(BorrowerEligibilityCheck eligibility) {
        ...
        creditProfileRepository.ensureNoHistory(application.getBorrowerId(), now);
        ...
        CreditScoringInput input = inputMapper.map(application, eligibility, creditProfile, schedule);
