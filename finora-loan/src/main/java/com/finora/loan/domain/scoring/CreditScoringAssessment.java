...
public class CreditScoringAssessment {
    ...
    /** Cấp execution attempt sau khi lấy lock; PROCESSING mất lease có thể được worker khác tiếp quản. */
    ...
    /** Thử lại cùng input snapshot và logical key; tuyệt đối không tạo điểm mặc định khi AI lỗi. */
    ...
    /** Kết thúc lỗi không thể tự phục hồi để hồ sơ chuyển sang hàng chờ admin xem xét. */
    ...
    /** Admin chỉ mở lại assessment FAILED; assessment SUCCEEDED là bằng chứng bất biến. */
