...
- **Sổ đối chiếu pháp lý:** [`../docs/LEGAL-COMPLIANCE.md`](../docs/LEGAL-COMPLIANCE.md)
- **AI contract hiện hành:** [`plans/LN-007-credit-profile-ai-assessment.md`](plans/LN-007-credit-profile-ai-assessment.md)
...
| LN-003 | Product min/base/max rate, repayment method, Fineract mapping | LN-001A được `ACCEPTED`; legal controls | `REVIEW` | [LN-003](plans/LN-003-loan-product.md) |
| LN-004 | Direct-submit Application và initial/final snapshots | LN-003, LN-006 | `REVIEW` | [LN-004](plans/LN-004-loan-application.md) |
...
- Loan đã chuyển sang AI v17 `/explain`, min/base/max pricing và final Fineract schedule; cần chạy lại migration/integration sạch và Hải review fixture v17 trước khi trả các LN về `ACCEPTED`.
...
| 2026-08-02 | LN-003–LN-008 | Bỏ LoanOffer; Contract là bước consent duy nhất; baseline fixed-rate/v10 | `SUPERSEDED` bởi quyết định 2026-09-05 |
...
| 2026-08-08 | LN-008 | Baseline cũ dùng một submission schedule cho Contract | `SUPERSEDED` bởi final schedule ngày 2026-09-05 |
