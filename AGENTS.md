# AGENTS.md — Điểm vào cho Codex trong FINORA

File này phải nằm ở gốc repository để Codex tự động phát hiện. Luật chi tiết chỉ có một nguồn chuẩn trong `.agents/rules/`; không sao chép luật chi tiết trở lại file này.
